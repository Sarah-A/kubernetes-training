#
# run the commands in this file on ALL VMs in your cluster - both the control node and all the worker nodes
#
...
#
# Don't forget to take a snapshot of your VMs so you can reset them to the state before creating the cluster.
#